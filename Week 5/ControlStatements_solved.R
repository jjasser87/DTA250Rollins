...
checkIfEqual <- function(x) {
  if (x == 1) {
    print("Argument is equal to 1")
  } else {
    print("Argument is not equal to 1")
  }
}
...
checkIfEqual <- function(x) {
  if (x == 1) {
    ...
    print("Argument is equal to 2")
  } else {
    print("Argument is not equal to 1 or 2")
  }
}
...
ifelse(toTest == 1, print("Yes"), print("No"))
...
ifelse(toTest == 1, toTest * 2, print("No"))
...
toTest <- c(1, 1, 0, 1, 0, 1)
toTest2 <- c(1, 1, 0, 0, 1, 1)
ifelse(toTest == 1 & toTest2 == 0, print("Yes"), print("No"))
