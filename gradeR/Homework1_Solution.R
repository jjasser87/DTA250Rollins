...
# Part 1: Variables ----
# Create a variable called first_number and assign it the numeric value of 5
first_number <- 5

# Create a variable called second_number and assign it the integer value of 2
second_number <- 2

# Create a variable called my_character and assign it the character value "hello"
my_character <- "hello"

# Create a variable called my_logical and assign it the logical value of TRUE
my_logical <- TRUE

# Part 2: Operations ----
# Add first_number and second_number and assign the result to a variable called sum_result.
sum_result <- first_number + second_number

# Divide first_number by second_number and assign the result to a variable called div_result.
div_result <- first_number / second_number

# Multiply first_number by my_logical and assign the result to a variable called mult_result.
mult_result <- first_number * my_logical

# Find the number of characters in my_character using nchar() and assign the result to a variable called char_result.
...
# Use the is.integer() function to check whether the type of second_number is integer.
...
# Use the == operator to check whether my_logical_check is equal to second_number_int_check.
...
log_vector <- c(FALSE, TRUE, TRUE)

# Multiply num_vector by log_vector and assign the result to a variable called mult_vector.
mult_vector <- num_vector * log_vector

# Produce the following vector (FALSE, TRUE, TRUE) by doing Boolean operations (==, !=, <, >, <=, >=) 
# on the num_vector and store the result in a variable called bool_vector.
# example: num_vector == 0
...
factor_vector_level <- factor(factor_vector, levels = c("cherry", "apple", "banana"))
# OR
