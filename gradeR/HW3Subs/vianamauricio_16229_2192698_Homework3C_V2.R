...
plot1 <- ggplot(data = penguins, aes(x = bill_length_mm)) +
                  geom_density() +
                  facet_grid(~species) +
                  labs(title = "Density Plot of Bill Length by Species", x = "Bill Length(mm)", y = "Density")# You code for the plot here
...
plot2 <- ggplot(data = diamonds, aes(x = carat, y = price)) +
                  ...
                  geom_smooth() +
                  labs(title = "Carat vs. Price by Cut Quality", x = "Carat", y = "Price")# Your code for the plot here
...
plot3 <- ggplot(data = mtcars, aes(x = factor(cyl), y = mpg)) +
  geom_boxplot() +
  labs(title = "Miles Per Gallon by Cylinder Number", x = "Number of Cylinders", y = "Miles Per Gallon (mpg)")# Your code for the plot here
...
plot4 <- ggplot(data = iris, aes(x = Petal.Length)) +
  ...
  facet_wrap(~Species) +
  labs(title = "Petal Length Distribution for Each Species", x = "Petal Length", y = "Count")# Your code for the plot here
