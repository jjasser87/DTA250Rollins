...
plot1 <- ggplot(penguins, aes(x = bill_length_mm)) +
  ...
  labs(title = "Density Plot of Bill Length by Species",
       x = "Bill Length (mm)",
       y = "Density") # You code for the plot here
...
plot2 <- ggplot(diamonds, aes(x = carat, y = price, color = cut)) +
  ...
  labs(title = "Carat vs. Price by Cut Quality",
       x = "Carat",
       y = "Price") # Your code for the plot here
...
plot3 <- ggplot(mtcars, aes(x = factor(cyl), y = mpg)) +
  ...
  labs(title = "Miles Per Gallon by Cylinder Number",
       ...
       y = "Miles Per Gallon (mpg)") # Your code for the plot here
...
plot4 <- ggplot(iris, aes(x = Petal.Length)) +
  ...
  labs(title = "Petal Length Distribution for Each Species",
       x = "Petal Length",
       y = "Count") # Your code for the plot here
