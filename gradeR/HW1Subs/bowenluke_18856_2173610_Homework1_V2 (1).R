...
# value of 2
second_number <-2  # Your code here
...
mult_result <- first_number * second_number # Your code here
  print(mult_result)
...
log_vector <- c("dog" = TRUE, "cat" = TRUE, "fish" = FALSE)  # Your code here
...
bool_vector <- num_vector>=2 # Your code here
...
factor_vector_level <- factor(factor_vector, levels=c("cherry","apple","banana"))  # Your code here
print(factor_vector_level)
