...
# "apple", "banana", "cherry"
char_vector <-  c("apple", "bannana", "cherry")
...
bool_vector <-  num_vector [c(FALSE, TRUE, TRUE)]
...
factor_vector_level <- factor(factor_vector, levels = c("cherry", "apple", "bannana"))
