...
bool_vector <- # Your code here
  bool_vector <- num_vector == c(2, 2, 3)

# Part 4: Factors
# Convert char_vector into a factor called factor_vector.
# Use as.factor() function.
factor_vector <-  # Your code here
...
factor_vector_level <-  # Your code here
