...
range_vector <- c(-5:7)# Your code here
...
log_vector <-c(TRUE , FALSE , TRUE )  # Your code here

# Multiply num_vector by log_vector and assign the result to a
# variable called mult_vector.
mult_vector <-(log_vector * num_vector)  # Your code here
...
num_vector <- c(FALSE, TRUE, TRUE)
bool_vector <- num_vector > 0 <-  # Your code here
...
factor_vector <- factor(c("banana", "apple", "cherry", "banana", "apple"))
new_levels <- c("cherry", "apple", "banana")
levels(factor_vector) <- new_levels
factor_vector_level <- factor_vector # Your code here
