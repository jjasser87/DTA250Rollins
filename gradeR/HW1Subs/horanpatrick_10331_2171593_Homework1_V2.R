...
mult_vector <-  log_vector * num_vector
...
bool_vector <- as.logical(num_vector > 1)
bool_vector
...
factor_vector_level <- as.factor(factor_vector)
levels(factor_vector_level) <- c(factor_vector[3],factor_vector[1], factor_vector[2])
factor_vector_level
