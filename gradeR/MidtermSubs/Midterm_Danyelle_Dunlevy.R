...
# Extract rows 5 tdata_frame()# Extract rows 5 to 10 and 20 to 22 of the following columns:
...
result <- popularity_5th * c(5:10, 20:22)

# What is the class of popularity_5th?
class_popularity_5th <- class("popularity")                        
...
# Set the mapping parameter to aes() function to specify the x-axis and y-axis variables. 
...
average_dance_energy <- function(dance, energy){
  average_dance_energy(dance+energy)/2
