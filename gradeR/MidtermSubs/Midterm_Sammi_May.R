...
average_dance_energy <- function(average, dance, energy) {
  if(average>.5) {
    return("High")
  }else if (average <= .5) {
    return("Low")
...
average_dance_energy(1,1)
average_dance_energy(.2,.2)
average_dance_energy(.5,.5)
average_dance_energy(.2,.7)
average_dance_energy(.8,.9)  
