...
rows_5_to_10_20_to_22 <- df[c(5:10,20:22),
                            c("danceability", "energy","key", "loudness")]
...
average_dance_energy(df$danceability[4], df$energy[5])
average_dance_energy(df$danceability[2], df$energy[3])
...
most_popular_artist <- "John Legend"
