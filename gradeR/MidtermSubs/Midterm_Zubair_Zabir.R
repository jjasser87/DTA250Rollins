...
print(class_popularity_5th)

# The class of popularity_5th can also be considered numeric.
# Anser TRUE or FALSE in the variable below

class_popularity_5th_is_numeric <- is.numeric(class_popularity_5th )

print(class_popularity_5th_is_numeric)
...
average_dance_energy(df$danceability[4], df$energy[2])
average_dance_energy(df$danceability[9], df$energy[20])
...
most_popular_artist <- q4df |>
  summarize(max_popularity = max(avg_popularity))


most_popular_artist # to check my answer
