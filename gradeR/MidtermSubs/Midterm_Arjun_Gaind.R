...
popularity_5th <- df[c(5), c("popularity")]
...
qf4d # to check your answer

# Write in the name as a character of the artist with the highest average popularity
most_popular_artist <- qf4d$artist[1]
