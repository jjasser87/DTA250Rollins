...
#average_dance_energy <- function(average_dance_energy{
#  if (average > 0.5) {
#    return("High")
#  } else if(average < 0.5) {
#    return("Low")
...
#q4df <- df|>
#  group_by( ,"artist") |>
#  select(, c("artist", "popularity", "danceability", "energy"))|>
#  filter(is.>.5(energy))|>
#  summarize(avg = mean("artist", "popularity", "danceability","energy") |>
