...
il_filter_percollege <- il_filter |>
  summarize(mean_percollege = mean(percollege))
...
avg_percollege_percbelowpoverty <- df |>
  ...
  summarize(mean_percollege = mean(percollege), mean_percbelowpoverty = mean(percbelowpoverty))
...
avg_sepal_length_petal_length_by_species <- iris |>
  ...
  summarize(mean_Sepal.Length = mean(Sepal.Length), mean_Petal.Length = mean(Petal.Length))
