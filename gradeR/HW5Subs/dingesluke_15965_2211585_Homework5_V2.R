...
std_dev_percchildbelowpovert_percbelowpoverty <- median_popadults <- midwest |>
  group_by(state) |>
  summarise(sd(percchildbelowpovert), sd(percbelowpoverty))
...
more_than_100_hp_less_than_20_mpg_more_than_6_cyl <- more_than_100_hp_more_than_4_cyl <- mtcars |>
