...
avg_percollege_percbelowpoverty <- midwest %>%
  summarize(avg_percollege = mean(percollege),
            avg_percbelowpoverty = mean(percbelowpoverty)) # Your code here
...
std_dev_percchildbelowpovert_percbelowpoverty <- midwest %>%
  group_by(state) %>%
  summarize(std_dev_percchildbelowpovert = sd(percchildbelowpovert),
            std_dev_percbelowpoverty = sd(percbelowpoverty)) # Your code here
