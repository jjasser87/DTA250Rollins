...
origin_year_columns <- 0 #df[, c("orgin", "year'")]
...
columns_1_to_4_acceleration <- 0 #df[, c(1:4, "acceleration")]
...
columns_1_to_4_acceleration_2_to_4_6 <- 0 #df[c(2:4, 6), c(1:4, "acceleration")]
