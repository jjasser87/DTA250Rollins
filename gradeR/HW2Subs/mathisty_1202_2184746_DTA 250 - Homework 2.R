...
horsepower_weight_10_to_15 <- df[10:15, c("horsepower", "year")]
...
cylinders_displacement_acceleration_30_to_45_47_79 <- df[c(30:45), 45, 47, 79, c("cylinders", "displacement", "acceleration")]
