...
cars_30_to_45_47_79 <- df[c(30:45, 47, 49), ]
...
cylinders_displacement_acceleration_30_to_45_47_79 <- df[c(30:45, 47), c(2:3, 6)]

# Access the first 4 columns and acceleration for cars at positions 2 to 4, and 6 in the dataset?
columns_1_to_4_acceleration_2_to_4_6 <- df[c(1:4, 6), c(2:4, 6)]
