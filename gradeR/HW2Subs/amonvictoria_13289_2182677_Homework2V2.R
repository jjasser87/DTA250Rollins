...
horsepower_first_car <- df[1,"horsepower"]# Your code here
  
# Access the number of cylinders (cylinders column) for the fifth car listed in df?
cylinders_fifth_car <- df[5, "cylinders"]# Your code here
  
# Access the weight of the third car in the df data frame.
weight_third_car <- df[3,"weight"]# Your code here
  
# Access the acceleration value of the tenth car in the dataset?
acceleration_tenth_car <- df[10,"acceleration"]# Your code here
...
origin_year_columns <- df[,c("year","origin")]# Your code here
