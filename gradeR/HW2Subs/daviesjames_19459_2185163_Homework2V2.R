...
weight_third_car <- df[3,5]  # Index should be 3 instead of 1

# Access the acceleration value of the tenth car in the dataset?
acceleration_tenth_car <- df[10,9]  # Index should be 9 instead of 10
