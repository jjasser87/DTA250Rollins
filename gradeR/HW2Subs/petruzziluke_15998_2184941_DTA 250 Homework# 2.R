...
# After that use the scale_color_colorblind() function
       ...
       ggplot(data = penguins,
              ...
              labs( x = "flipper length",
                    ...
                    subtitale = "data from the palmerpenguins package"
                    color = "species",
                    shape = "species") +
...
ggplot(data = penguins(aes = mapping(x = "body_mass", color = "species")))
...
ggplot( mapping = aes(x = "island", fill = "species")) + geom_bar()
