...
origin_year_columns <- df[ ,c("year", "origin")]
...
# before, instead of 6 I put "acceleration" however it said undefined column.
# it looked like this: df[, c(1:4, "acceleration")]
...
# here I had the same issue with "acceleration", see line 70
