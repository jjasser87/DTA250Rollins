...
print(names(df))
columns_1_to_4_acceleration <- df[, c(1:4, which(names(df) == "acceleration"))]
...
horsepower_weight_10_to_15 <- df[10:15, c("horsepower")]
...
columns_1_to_4_acceleration_2_to_4_6 <- df[c(2:4, 6), c(1:4, which(names(df) == "acceleration"))]
