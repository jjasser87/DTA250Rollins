...
Boston_long <- pivot_longer(Boston, everything(), names_to = "Variable", values_to = "Value")
...
all_plot <- ggplot(Boston_long, aes(x = Value)) + geom_histogram() + facet_wrap(~Variable, scales = "free")
