...
# Calculate area of triangle with base 5 and height 7
area1 <- area_triangle(5, 7)


# Calculate area of triangle with base 10 and height 15
area2 <- area_triangle(10, 15)
...
even_or_odd(evenodd8)
even_or_odd(evenodd5)
# Question 3 ----
