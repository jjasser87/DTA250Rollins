...
even_or_odd <- as.integer(readline(prompt="Enter a number: "))
if((num %% 2) == 0) {
  print(paste(even_or_odd(),"is Even"))
} else {
  print(paste(even_or_odd(),"is Odd"))
} #Your code here
...
celsius_to_fahrenheit <- function(celsius){
  return((celsius * 9/5) + 32) } #Your code here
